    ...
    return (
      ...
      <Container maxWidth="md">
        ...
        <div  className={classes.root} style={{padding: "70px 0"}} >
                     ...
                     }}> {props.title} Card <span> <CloudDownloadIcon style={{fontSize: "3.7vw", marginLeft: "20px"}} /> </span></div>
            
            
        <Grid  container spacing={2} style={{marginTop: "60px"}}>
              <Grid item xs={12} sm={6} lg={6}>
                <Link to={props.link}>
                  <button className="btn" > Create <AddIcon /> </button>
                </Link>
          
        </Grid>
        <Grid item  xs={12} sm={6} lg={6}>
          <button className="btn" onClick={props.viewClick} > View <PageviewIcon />  </button>
        </Grid>
